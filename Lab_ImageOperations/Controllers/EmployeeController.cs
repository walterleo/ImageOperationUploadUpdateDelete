...
namespace WebApp.Controllers
{
  ...
  {
    AppDbContext _db; private readonly IWebHostEnvironment webHostEnvironment; 


    public EmployeeController(AppDbContext db, IWebHostEnvironment hostEnvironment) 
    { 
      _db = db; webHostEnvironment = hostEnvironment; 
    }
    ...
    [HttpPost] public IActionResult Create(EmployeeViewModel model) 
    { 
    ...
    {
      Employee data = _db.Employees.Find(id); EmployeeViewModel model = new EmployeeViewModel(); // ViewModel
